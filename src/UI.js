...
let displayController = (function () {
    ...
    //append to each task his own description
    ...
    //function that gets all tasks and displays them
    ...
    //function that filter the task based on today and displays them
    ...
    //function which filter the tasks of the week and displays them
    ...
    //filter the tasks with high priority and displays them
    ...
    //display the tasks of each project when clicked
